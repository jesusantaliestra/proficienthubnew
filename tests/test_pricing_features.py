...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://proficient-hub.preview.emergentagent.com').rstrip('/')
...
class TestStripeCheckout:
    ...
    def test_subscription_checkout_endpoint_exists(self):
        ...
        response = requests.post(
            ...
            json={
                ...
                "origin_url": "https://proficient-hub.preview.emergentagent.com"
            }
        )
    ...
    def test_test_package_checkout_endpoint_exists(self):
        ...
        response = requests.post(
            f"{BASE_URL}/api/checkout/test-package?package_type=writing&package_id=writing_100&origin_url=https://proficient-hub.preview.emergentagent.com"
        )
